      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Have questions or feedback? Our team is here to help you stay safe during your travels.
          </p>
        </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <Mail className="h-6 w-6 text-blue-600 dark:text-blue-400 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Email Us</h3>
                    <p className="mt-1 text-gray-600 dark:text-gray-300">
                      <a href="mailto:support@travelsafe.com" className="hover:text-blue-600 dark:hover:text-blue-400">
                ...
                <div className="flex items-start">
                  <Phone className="h-6 w-6 text-blue-600 dark:text-blue-400 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Call Us</h3>
                    <p className="mt-1 text-gray-600 dark:text-gray-300">
                      <a href="tel:+18001234567" className="hover:text-blue-600 dark:hover:text-blue-400">
                        +1 (800) 123-4567
                      </a>
                    </p>
                ...
                <div className="flex items-start">
                  <MapPin className="h-6 w-6 text-blue-600 dark:text-blue-400 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Visit Us</h3>
                    <p className="mt-1 text-gray-600 dark:text-gray-300">
                      123 Travel Street<br />
                      Safety Building, Floor 4<br />
                      New York, NY 10001
                    </p>
                  </div>
                </div>
